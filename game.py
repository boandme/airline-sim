...
def buy_plane():
    ...
    if plane_choice in aircrafts and money >= aircrafts[plane_choice]["cost"]:
        ...
        print(
            "Either that plane does not exist or you don't have enough money to buy it"
        )
...
def disaster():
    ...
    if num == 1:
        ...
        if num2 == 1:
            print(
                "Your plane's engine overheated and exploded midway through the flight! Unfortunately, the plane therefore crashed and all passengers died"
            )
            loss = random.randint(15000, 100000)
            print(
                f"The victims' families sued your company and in total, you lost ${loss}"
            )
            ...
            print(
                "Your plane's cabin lost a high amount of pressure at the beggining of the flight and the nose of your aircraft broke apart.  Unfortunately, the plane therefore crashed and all passengers died"
            )
        ...
        opt2 = input(
            "A terrible lightning storm is ahead of your flight path, but there might be a chance of making it through. Do you emergency land the plane in a nearby city(1) or take the risk(2)? - enter 1 or 2: "
        )
        if opt2 == "1":
            print(
                "You successfully managed to perform an emergency landing and not damage the aircraft"
            )
            print(
                "However you did lose some money due to the passengers not being able to arrive at their destination timely."
            )
            ...
            if num3 < 3.5:
                print(
                    "You successfully navigated the storm and landed at your destination in time! Good Work! "
                )
                print(
                    "You also earned some extra money because of the tips from passengers who enjoyed your pilots' flying skills"
                )
                tips = random.randint(100, 1500)
                print(f"You earned an extra ${tips} in tips!")
            else:
                print(
                    "Sadly, your plane coudln't make it through the dangerous storm... should have played it safe "
                )
                print(
                    "Many passengers sued your airline for terrible flying skills and bad decision making. "
                )
...
while playing:
    ...
    if options == "2":
        ...
        while True:
            aircraft = input(
                "Which Aircraft from your collection would you like to choose? "
            )
        ...
        print()
        print(
            f"Your flight from {p1} to {p2} has been scheduled for {hours}:{minutes} {time_of_day}"
        )
        ...
        if (
            ...
            or (p1 in east and p2 in east)
            or (p1 in mid and p2 in mid)
        ):
        ...
        main_cost = 0
        main_cost = (
            aircrafts[aircraft]["passengers"] * aircrafts[aircraft]["per_passenger"]
        )
        ...
        if num4 == 6:
            ...
            print(
                f"Total flight time: {hours_spent} hour(s) and {minutes_spent} minute(s)"
            )
